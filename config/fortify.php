...
return [
    ...
    */
    ...
    // Только вход/выход: регистрация, сброс пароля, верификация email,
    // 2FA, passkeys и обновление профиля отключены. Пользователей создаёт
    // администратор командой `php artisan users:create`.
    'features' => [],
