...
MockAdapter, часть 1) выполнен 2026-09-19; этап 07 (метрики остатков) — тоже; этап 08 (правки метрик остатков, сравнение периодов, топ/анти-топ) — тоже; этап 09 (оборачиваемость со стартовым остатком, аутентификация standalone) — тоже. Этапы 10
