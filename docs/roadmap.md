...
клиента/доступа к Bitrix24/1С; следующий реальный шаг — начать этап 11
или 12, когда появится клиент.
