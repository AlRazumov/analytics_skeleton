...
| 07 | Bitrix24Adapter | — | not planned (отложен на неопределённый срок, ждёт клиента) | 06 |
| 08 | OneCAdapter | — | not planned (отложен на неопределённый срок; заказчик тянет время, может не состояться) | 06 |

## TODO before real adapters

Пункты, которые нужно пересмотреть перед стартом этапов 07/08 (реальные,
...
MockAdapter, часть 1) выполнен 2026-09-19. Этапы 07
(`Bitrix24Adapter`) и 08 (`OneCAdapter`) — not planned, ждут появления
...
клиента/доступа к Bitrix24/1С; следующий реальный шаг — начать этап 07
или 08, когда появится клиент.
