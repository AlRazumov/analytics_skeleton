...
| 09 | Оборачиваемость: стартовый остаток; аутентификация standalone-части (Fortify) | stages/stage-09-turnover-and-auth.md | in progress | 06, 07, 08 |
...
MockAdapter, часть 1) выполнен 2026-09-19; этап 07 (метрики остатков) — тоже; этап 08 (правки метрик остатков, сравнение периодов, топ/анти-топ) — тоже; этап 09 (оборачиваемость, аутентификация standalone) в работе. Этапы 10
(`Bitrix24Adapter`) и 11 (`OneCAdapter`) — not planned, ждут появления
...
клиента/доступа к Bitrix24/1С; следующий реальный шаг — начать этап 10
или 11, когда появится клиент.
