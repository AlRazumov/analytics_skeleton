...
| 12 | Витрина на моке: оборачиваемость, графики новых метрик, YoY, демо-режим | stages/stage-12-showcase.md | in progress | 09, 10, 11 |
| 13 | Bitrix24Adapter | — | not planned (отложен на неопределённый срок, ждёт клиента) | 06 |
| 14 | OneCAdapter | — | not planned (отложен на неопределённый срок; заказчик тянет время, может не состояться) | 06 |

## TODO before real adapters

Пункты, которые нужно пересмотреть перед стартом этапов 13/14 (реальные,
...
клиента/доступа к Bitrix24/1С; следующий реальный шаг после этапа 12 — начать этап 13
или 14, когда появится клиент.
